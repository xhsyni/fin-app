# Generated by Django 5.1.2 on 2025-05-17 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expenseid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.expense')),
                ('incomeid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.income')),
            ],
            options={
                'db_table': 'file',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deduction', models.DecimalField(db_column='deduction', decimal_places=2, max_digits=12)),
                ('amount', models.DecimalField(db_column='amount', decimal_places=2, max_digits=12)),
                ('job', models.CharField(db_column='job', max_length=30, null=True)),
                ('userid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
